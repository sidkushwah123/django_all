...
!function ($) {
    ...
    Multiselect.prototype = {
        ...
        defaults: {
            ...
            inheritClass: false,
            buttonWidth: 'auto',
            buttonContainer: '<div class="mltbox" />',
            dropRight: false,
            ...
            templates: {
                ...
                filterClearBtn: '<span class="input-group-btn"><button class="form-control multiselect-clear-filter" type="button"><i class="glyphicon glyphicon-remove-circle"></i></button></span>',
        ...
        createOptionValue: function(element) {
            ...
            var inputType = this.options.multiple ? "checkbox" : "checkbox";
